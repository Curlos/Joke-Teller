...
const API_KEY = '347811602c8b47b0ac2c9616a9b015bc'
const TEXT_TO_SPEECH_API_URL = 'http://api.voicerss.org/?key=API_KEY&hl=en-us&src='

const toggleButton = () => {
    button.disabled = !button.disabled
}

const tellJoke = async (jokeString) => {
    jokeString = jokeString.trim().replace(/ /g, '%20');
...
buttonElement.addEventListener('click', getJokeFromAPI)
audioElement.addEventListener('click', toggleButton)